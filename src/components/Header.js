        ...
        <>
                    ...
                    <div className="row">
                        ...
                        <div className="col-6">
                            <p className="text-end text-white mb-0">
                                Destek: <a className="text-white" href="tel:+312 580 36 63">(+312) 580 36 63</a>
                            </p>
                        </div>
                    </div>
                </div>
            ...
            <header className="header-upper py-3">
                <div className="row">
                    <div className="col-2">
                        <h2>
                            <Link className="text-white"> Almaliyim</Link>
                        </h2>
                    </div>
                    <div className="col-5">
                        ...
                        <div className="header-upper-links d-flex align-items-center justify-content-between">
                            <div>
                                <Link to='/compare-product' className="d-flex align-items-center gap-10 text-white">
                                    ...
                                    <p className="mb-0">Ürün <br /> Karşilaştir</p>
                                </Link>
                            </div>
                            <div>
                                <Link to='/wishlist' className="d-flex align-items-center gap-10 text-white">
                                    <img src="images/wishlist.svg" alt="wishlist" />
                                    <p className="mb-0">Favori <br /> Listesi</p>
                                </Link>
                            </div>
                            <div>
                                <Link to='/login' className="d-flex align-items-center gap-10 text-white">
                                    <img src="images/user.svg" alt="user" />
                                    <p className="mb-0">Hesaba <br /> Giriş Yap</p>
                                </Link>
                            </div>
                            <div>
                        ...
                        <div className="menu-bottom d-flex align-items-center gap-30">
                            ...
                            <div className="menu-links">
                                <div className="d-flex align-items-center gap-15">
                                    ...
                                    <NavLink to="/product">Mağazam</NavLink>
